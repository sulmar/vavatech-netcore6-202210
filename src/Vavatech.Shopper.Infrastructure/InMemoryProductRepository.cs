...
namespace Vavatech.Shopper.Infrastructure
{
    public class InMemoryProductRepository : InMemoryEntityRepository<Product>, IProductRepository
    {
        public InMemoryProductRepository()
        {
            ...
            {
                new Product { Id = 1, Name = "Product 1", Color = "Red", Price = 1000 },
                new Product { Id = 2, Name = "Product 2", Color = "Green", Price = 2000 },
                new Product { Id = 3, Name = "Product 3", Color = "Blue", Price = 4000 },
            };
